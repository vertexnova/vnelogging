...
/**
 * @class SyncLogger
 * @brief Synchronous logger class.
 *
...
class SyncLogger : public ILogger {
   public:
     ...
     *
     * @param sink A unique pointer to a sink.
     */
    void addLogSink(std::unique_ptr<ILogSink> sink) override;
     ...
     *
     * This factory method creates a new instance of the synchronous logger with a
     * specified name.
     *
